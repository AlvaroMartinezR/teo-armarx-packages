...
#ifndef _ARMARX_XMLUSERCODE_WavingReDo_WavingReDo_SetJoints_H
#define _ARMARX_XMLUSERCODE_WavingReDo_WavingReDo_SetJoints_H

#include <WavingReDo/statecharts/WavingReDo/SetJoints.generated.h>
...
namespace armarx
{
    ...
    {
        class SetJoints :
            public SetJointsGeneratedBase < SetJoints >
        {
        public:
            SetJoints(const XMLStateConstructorParams& stateData):
